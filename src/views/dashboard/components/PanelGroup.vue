    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelGroupData.serviceNum" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelGroupData.appNum" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
...
import { servicePanelData } from '@/api/service'
export default {
  components: {
    CountTo
  },
  ...
  methods: {
    fetchData() {
      servicePanelData().then((response) => {
